...
class MacAddressConfigViewCell: UITableViewCell {
    
    private var _appConfig: AppConfig = (UIApplication.shared.delegate as! AppDelegate).appConfig
    
    @IBOutlet weak var value: UILabel!
    private var _parent: UITableViewController! = nil
    
    func update(value: String, parent: UITableViewController) {
...
class SettingsViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        return section == 0 ? "MAC Address" : ""
    }
    
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: indexPath.section == 0 ? "ConfigCell" : "", for: indexPath)
